---
title: deployit API
description: How to interact with the deployit API for administrators and users
---

In some cases, you may need to interact directly with the deployit API. Here's how both administrators and users can do this.
...
By default the OpenApi base url is `http://localhost:3000/api`, you need to replace with the ip of your deployit instance or the domain name.
...
```bash
curl -X 'GET' \
  'https://deployit.com/api/project.all' \
