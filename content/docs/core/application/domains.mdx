...
This section outlines how to configure domains for your applications in deployit, ensuring that your applications are accessible via custom URLs.
...
- **Host**: The domain name that you want to link to your application (e.g., `api.deployit.com`).
...
- **Certificate**: Select whether to secure the domain with SSL/TLS certificates. deployit supports automatic provisioning of SSL certificates via Let's Encrypt.
