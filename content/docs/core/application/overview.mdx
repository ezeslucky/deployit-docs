---
title: Overview
description: "Explore the multiple deployment methods available in deployit, including GitHub, Git, Docker, and automated deployments via webhooks."
---

Applications in deployit are treated as a single service or container, making it easy and intuitive for users to work with each application in its own workspace.
