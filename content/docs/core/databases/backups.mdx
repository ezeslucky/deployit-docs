---
title: Backups
description: "Learn how to schedule and manage backups for your databases in deployit, with options for storage in S3 buckets."
---

deployit provides an integrated solution for backing up your databases, ensuring data safety and recovery capabilities.

## Backing Up Your Database

To configure database backups, navigate to the `Backup` tab within your deployit dashboard. Here’s what you’ll need to set up:
