---
title: Connection
description: "Learn how to connect to your database using deployit."
---

This section explains how to configure database access for applications in deployit, including both internal connections within your network and external connections accessible over the internet.
