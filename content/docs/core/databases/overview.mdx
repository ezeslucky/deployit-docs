---
title: Overview
description: "Discover how to create and backup databases easily with deployit, supporting a variety of database systems."
---

deployit simplifies the process of creating and managing databases, offering robust options for both setup and backups.

## Database Support

deployit currently supports a range of popular database systems, ensuring compatibility and flexibility for your projects:
