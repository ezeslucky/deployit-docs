---
title: Auto-deploy
description: How to auto-deploy your docker-compose application with deployit
---

Automatically deploying your docker-compose application to deployit can be achieved through two primary methods: using Webhooks or the deployit API. Each method supports various platforms and provides a streamlined deployment process.
