...
deployit offers several deployment methods, streamlining the process whether you're utilizing GitHub, any Git provider, Raw, or automated deployments.
...
2. When creating an application, deployit automatically retrieves the available repositories and branches.
...
<ImageZoom src="/assets/deployit-ssh-compose.png" width={800} height={630} className="rounded-lg"/>
