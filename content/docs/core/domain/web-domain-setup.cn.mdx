---
title: "Web 域名设置"
description: "学习如何为 deployit 面板设置主域名"
---

## 介绍

本指南涵盖 deployit 面板主域名的基本设置。
...
4. 保存记录。 您的 DNS 记录将是 `web.deployit.com`.
...
3. 在服务器域下，将您的域设置为与 Cloudflare 中配置的域相匹配(例如, `web.deployit.com`).
4. 保存，应用更改需要约 20 秒的时间生效。
5. 通过以下方式访问您的面板 `https://web.deployit.com`.

<ImageZoom  src="/assets/images/web-domain-setup/deployit-domain.png" width={800} height={630} quality={100} priority alt='home og image' className="rounded-lg" />
