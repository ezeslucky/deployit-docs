...
description: "Learn how to setup a main domain for the deployit panel"
---

This guide covers the basic setup of a main domain for your deployit panel.
...
4. Save the record. Your DNS record will be `canary.deployit.com`.
...
## deployit Panel Setup

1. Log in to your deployit panel.
2. Navigate to `/dashboard/settings/server`.
3. Under Server domain, set your domain to match the one configured in Cloudflare (e.g., `canary.deployit.com`).
4. Choose your certificate option:
   - `None`
   - `Let's Encrypt`
6. Access your panel via `https://canary.deployit.com`.
...
<ImageZoom src="/assets/images/web-domain-setup/deployit-setup.png" width={800} height={630} quality={100} priority alt='home og image' className="rounded-lg" />