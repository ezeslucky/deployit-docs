---
title: Overview
description: 'Explore the comprehensive monitoring features in deployit for tracking the performance of applications, databases, and server resources.'
---


deployit includes a robust monitoring system designed to give you real-time insights into your applications, databases, and server performance.
...
- **Historical Data**: For applications or databases that are not currently running, deployit displays the last recorded metrics.
...
These monitoring tools in deployit provide essential data that helps you manage resources effectively, ensuring optimal performance of your server and hosted applications.