---
title: Users
description: 'Manage user roles and permissions within deployit. Admin roles are limited to one per instance.'
---
import { Callout } from 'fumadocs-ui/components/callout';

Manage user roles and permissions within deployit. Note that only one admin role is allowed per instance.

## Permissions

deployit offers multiple permissions to manage your users effectively:
