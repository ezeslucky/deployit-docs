---
title: Templates
description: Deploy open source templates with deployit
---
...
We accept contributions to upload new templates to the deployit repository.

Make sure to follow the guidelines for creating a template:

[Steps to create your own template](https://github.com/deployit/deployit/blob/canary/CONTRIBUTING.md#templates)